...
resource_policy "null_resource" "update_operation_policy12@#%/" {
    enforceent_level = input.enforcement_level
    operations = ["update"]
    enforce {
        condition = attrs.triggers == null
        ...
        info_message  = "deployment group: ${meta.tfe_stack.deployment_group}, deployment name: ${meta.tfe_stack.deployment_name}, stack: ${meta.tfe_stack.stack_name} ot allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resource update operation is not allowed for null_resourceupdate operation is not allowed for null_resourceupdate operation is not allowed for null_resourceupdate operation is not allowed for null_resourceupdate operation is not allowed for null_resourceupdate operation is not allowed for null_resource"
    }
}
